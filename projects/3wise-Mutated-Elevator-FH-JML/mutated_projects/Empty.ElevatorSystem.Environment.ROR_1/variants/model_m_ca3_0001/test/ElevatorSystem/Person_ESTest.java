...
public class Person_ESTest extends Person_ESTest_scaffolding {
  ...
  public void test15()  throws Throwable  {
      Environment environment0 = new Environment(2718);
      Person person0 = new Person("D*qy\"", 58, 58, 58, environment0);
      boolean boolean0 = person0.isDestinationReached();
      assertEquals(58, person0.getOrigin());
      assertEquals(58, person0.getWeight());
      assertFalse(boolean0);
      assertEquals(58, person0.getDestination());
  }
