...
public class Person_ESTest extends Person_ESTest_scaffolding {
  ...
  public void test15()  throws Throwable  {
      Environment environment0 = new Environment(2694);
      Person person0 = new Person("UX8Di;Fvv", 20, 20, 20, environment0);
      boolean boolean0 = person0.isDestinationReached();
      assertEquals(20, person0.getWeight());
      assertFalse(boolean0);
      assertEquals(20, person0.getOrigin());
      assertEquals(20, person0.getDestination());
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      Environment environment0 = new Environment(151);
      Person person0 = new Person("LBQ?jx", 20, 20, 20, environment0);
      int int0 = person0.getWeight();
      assertFalse(person0.isDestinationReached());
      assertEquals(20, person0.getDestination());
      assertEquals(20, person0.getOrigin());
