...
public class Elevator_ESTest extends Elevator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Environment environment0 = new Environment(749);
  ...
  public void test02()  throws Throwable  {
      ...
      Environment environment0 = new Environment(1922);
      Elevator elevator0 = new Elevator(environment0, true, 4, false);
      elevator0.isExecutiveFloor(4);
      elevator0.isEmpty();
      Floor[] floorArray0 = new Floor[1];
      environment0.floors = floorArray0;
      elevator0.executiveFloor = 1131;
      Environment environment1 = new Environment(1922);
      environment1.floors = floorArray0;
      Floor floor0 = new Floor(environment1, 1922);
      floorArray0[0] = floor0;
      environment0.floors = floorArray0;
  ...
  public void test03()  throws Throwable  {
      ...
      Environment environment1 = new Environment(711);
      Floor floor0 = new Floor(environment1, 711);
      floorArray0[0] = floor0;
      Floor floor1 = new Floor(environment1, 711);
      floorArray0[1] = floor1;
      int int1 = 2823;
      Floor floor2 = new Floor(environment0, 2823);
      floorArray0[2] = floor2;
      Environment environment2 = new Environment(737);
      // Undeclared exception!
      try { 
        environment2.getFloor(4918);
  ...
  public void test05()  throws Throwable  {
      ...
      elevator0.isExecutiveFloorCalling();
      elevator0.isEmpty();
      String string0 = "[`8u!+~=NOaBznmq(Wx";
      // Undeclared exception!
      try { 
        Elevator.Direction.valueOf("[`8u!+~=NOaBznmq(Wx");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No enum constant ElevatorSystem.Elevator.Direction.[`8u!+~=NOaBznmq(Wx
         //
         verifyException("java.lang.Enum", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Elevator elevator0 = new Elevator(environment0, false);
      Environment environment1 = new Environment(1403);
      Person person0 = new Person("MS%;=y%$twk^NZ", 1398, 379, 0, environment1);
      elevator0.enterElevator(person0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      environment0.floors = floorArray0;
      Elevator elevator0 = new Elevator(environment0, false);
      Person person0 = new Person("MS%;=%$twk^NZ", 0, 0, 0, environment0);
      elevator0.enterElevator(person0);
      elevator0.leaveElevator(person0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      floorArray0[0] = floor0;
      environment0.floors = floorArray0;
      Person person0 = new Person("ElevatorSystem.Elevator$DoorState", 0, 0, 0, environment0);
  ...
  public void test20()  throws Throwable  {
      ...
      Floor floor0 = environment0.getFloor(0);
      floorArray0[0] = floor0;
      Floor floor1 = new Floor(environment0, (-1218));
      // Undeclared exception!
      try { 
        environment0.getFloor(1403);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test43()  throws Throwable  {
      Environment environment0 = new Environment(2375);
      Elevator elevator0 = new Elevator(environment0, false, 726, false);
      boolean[] booleanArray0 = new boolean[2];
      booleanArray0[0] = false;
      booleanArray0[1] = false;
      Person person0 = new Person("P`hD", 726, 745, 726, environment0);
  ...
  public void test44()  throws Throwable  {
      // Undeclared exception!
      try { 
        Elevator.Direction.valueOf("y9EM");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No enum constant ElevatorSystem.Elevator.Direction.y9EM
         //
         verifyException("java.lang.Enum", e);
      }
  }
  ...
  public void test45()  throws Throwable  {
      Environment environment0 = new Environment(31);
      Floor[] floorArray0 = new Floor[1];
      Floor floor0 = new Floor(environment0, 31);
      floorArray0[0] = floor0;
      environment0.floors = floorArray0;
      Elevator elevator0 = new Elevator(environment0, true, 0, true);
      elevator0.isIdle();
      ...
      // Undeclared exception!
      try { 
        elevator0.buttonForFloorIsPressed(406);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test46()  throws Throwable  {
      ...
      Person person0 = null;
      try {
        person0 = new Person("MS%;=y%$twk^NZ", 0, 0, 0, environment0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test49()  throws Throwable  {
      ...
      Person person0 = null;
      try {
        person0 = new Person("CNomxSfpmr*]Li4x:p", 2, 2, 2971, environment0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test52()  throws Throwable  {
      // Undeclared exception!
      try { 
        Elevator.Direction.valueOf("RxXjT|ppCL!");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No enum constant ElevatorSystem.Elevator.Direction.RxXjT|ppCL!
         //
         verifyException("java.lang.Enum", e);
      }
  }
