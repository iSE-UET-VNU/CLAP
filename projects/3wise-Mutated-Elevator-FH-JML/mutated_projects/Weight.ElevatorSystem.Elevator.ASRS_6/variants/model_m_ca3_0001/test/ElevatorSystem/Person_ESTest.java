...
public class Person_ESTest extends Person_ESTest_scaffolding {
  ...
  public void test15()  throws Throwable  {
      Environment environment0 = new Environment(1183);
      Person person0 = new Person("X8c@i;wvv", 0, 0, 0, environment0);
      boolean boolean0 = person0.isDestinationReached();
      assertEquals(0, person0.getDestination());
      assertEquals(0, person0.getOrigin());
      assertEquals(0, person0.getWeight());
  ...
  public void test16()  throws Throwable  {
      Environment environment0 = new Environment(4861);
      Person person0 = new Person("3fohiLc)6", 18, 18, 18, environment0);
      int int0 = person0.getWeight();
      assertEquals(18, person0.getDestination());
      assertEquals(18, person0.getOrigin());
      assertFalse(person0.isDestinationReached());
  ...
  public void test17()  throws Throwable  {
      ...
      assertFalse(person0.isDestinationReached());
      assertEquals(18, int0);
      assertEquals(18, person0.getWeight());
  }
}
