...
public class Elevator_ESTest extends Elevator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Environment environment0 = new Environment(1418);
      ...
      elevator0.toString();
      elevator0.isEmpty();
      Person person0 = new Person("Elevator []  at 1 heading down", 1418, 310, 310, environment0);
      elevator0.leaveElevator(person0);
      elevator_Direction0.reverse();
      elevator0.timeShift();
      // Undeclared exception!
      try { 
        elevator0.buttonForFloorIsPressed(1671);
  ...
  public void test01()  throws Throwable  {
      ...
      elevator0.toString();
      elevator0.isEmpty();
      Person person0 = new Person("Elevator []  at 1 heading up", 1418, 310, 310, environment0);
      elevator0.leaveElevator(person0);
      elevator0.timeShift();
      // Undeclared exception!
      try { 
  ...
  public void test02()  throws Throwable  {
      Environment environment0 = new Environment(930);
      Elevator elevator0 = new Elevator(environment0, true);
      elevator0.isBlocked();
  ...
  public void test42()  throws Throwable  {
      // Undeclared exception!
      try { 
        Elevator.DoorState.valueOf("saE N!^");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No enum constant ElevatorSystem.Elevator.DoorState.saE N!^
         //
         verifyException("java.lang.Enum", e);
      }
  }
  ...
  public void test43()  throws Throwable  {
      Environment environment0 = new Environment(4422);
      Elevator elevator0 = new Elevator(environment0, true);
      Person person0 = new Person("IR", 2, 2, 1012, environment0);
      elevator0.leaveElevator(person0);
  }
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        Elevator.Direction.valueOf("x");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No enum constant ElevatorSystem.Elevator.Direction.x
         //
         verifyException("java.lang.Enum", e);
      }
  }
