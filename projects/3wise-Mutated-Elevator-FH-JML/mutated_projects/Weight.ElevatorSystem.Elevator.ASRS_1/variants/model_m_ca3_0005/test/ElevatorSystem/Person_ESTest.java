...
public class Person_ESTest extends Person_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Person person0 = new Person("b|C$g", 0, 0, 0, environment0);
  ...
  public void test02()  throws Throwable  {
      Environment environment0 = new Environment(2845);
      Person person0 = new Person("+9", 2845, 1255, 1255, environment0);
      int int0 = person0.getWeight();
      assertFalse(person0.isDestinationReached());
      assertEquals(1255, person0.getDestination());
      assertEquals(1255, person0.getOrigin());
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals(1255, person0.getDestination());
      assertEquals(2845, person0.getWeight());
      assertFalse(person0.isDestinationReached());
  }
  ...
  public void test05()  throws Throwable  {
      Environment environment0 = new Environment(2);
      Person person0 = new Person((String) null, 2, 0, 441, environment0);
      person0.getName();
  ...
  public void test06()  throws Throwable  {
      Environment environment0 = new Environment(606);
      Person person0 = new Person("[] ", 0, 0, 0, environment0);
      person0.getName();
      assertFalse(person0.isDestinationReached());
      assertEquals(0, person0.getWeight());
  ...
  public void test08()  throws Throwable  {
      Environment environment0 = new Environment(2763);
      Person person0 = new Person("", 5172, 0, (-1), environment0);
      int int0 = person0.getDestination();
      assertFalse(person0.isDestinationReached());
      assertEquals((-1), int0);
      assertEquals(5172, person0.getWeight());
  }
  ...
  public void test13()  throws Throwable  {
      Environment environment0 = new Environment(1546);
      Person person0 = new Person("@9", 34, 34, 34, environment0);
      int int0 = person0.getDestination();
      assertEquals(34, person0.getOrigin());
      assertFalse(person0.isDestinationReached());
      assertEquals(34, person0.getWeight());
