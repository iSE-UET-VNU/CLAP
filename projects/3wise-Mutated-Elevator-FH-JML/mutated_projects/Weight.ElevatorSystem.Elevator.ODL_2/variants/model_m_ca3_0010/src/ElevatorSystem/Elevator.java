...
public   class  Elevator {
	...
	//__feature_mapping__ [Base] [50:52]
	...
	/*@ 
	  ...
	  @*/
	//__feature_mapping__ [Empty] [34:37]
	...
	/*@ 
	  ...
	  @*/
	//__feature_mapping__ [Empty] [25:28]
	...
	private boolean stopRequestedInDirection (Direction dir, boolean respectFloorCalls, boolean respectInLiftCalls) {
		if (weight > maximumWeight*2/3 && isAnyLiftButtonPressed()) {
			...
			return stopRequestedInDirection__wrappee__Base(dir, false, respectInLiftCalls);
