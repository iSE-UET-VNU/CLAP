...
public class Person_ESTest extends Person_ESTest_scaffolding {
  ...
  public void test12()  throws Throwable  {
      ...
      Person person0 = new Person("ElevatorSystem.Elevator$DoorState", 619, 619, 619, environment0);
      boolean boolean0 = person0.isDestinationReached();
      assertFalse(boolean0);
      assertEquals(619, person0.getDestination());
      assertEquals(619, person0.getOrigin());
      assertEquals(619, person0.getWeight());
  }
