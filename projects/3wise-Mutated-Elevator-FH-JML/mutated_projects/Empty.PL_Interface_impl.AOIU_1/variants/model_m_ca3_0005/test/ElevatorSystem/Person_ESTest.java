...
public class Person_ESTest extends Person_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Person person0 = new Person("", 1124, 1124, 1124, environment0);
      int int0 = person0.getWeight();
      assertEquals(1124, int0);
      assertFalse(person0.isDestinationReached());
      assertEquals(1124, person0.getDestination());
      assertEquals(1124, person0.getOrigin());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals(1124, int0);
      assertEquals(1124, person0.getDestination());
      assertEquals(1124, person0.getWeight());
  }
  ...
  public void test13()  throws Throwable  {
      Environment environment0 = new Environment(1513);
      Person person0 = new Person("XT", 25, 25, 25, environment0);
      int int0 = person0.getDestination();
  ...
  public void test17()  throws Throwable  {
      ...
      Person person0 = new Person(">a;q% Ik", 0, 0, 0, environment0);
      person0.getName();
      assertEquals(0, person0.getWeight());
      assertFalse(person0.isDestinationReached());
      assertEquals(0, person0.getDestination());
