...
public class Person_ESTest extends Person_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Environment environment0 = new Environment(1496);
      Person person0 = new Person("ElevatorSystem.Person", 22, 22, 22, environment0);
      int int0 = person0.getWeight();
      assertFalse(person0.isDestinationReached());
      assertEquals(22, person0.getDestination());
      assertEquals(22, person0.getOrigin());
  ...
  public void test05()  throws Throwable  {
      ...
      assertFalse(person0.isDestinationReached());
      assertEquals(22, person0.getDestination());
      assertEquals(22, person0.getWeight());
      assertEquals(22, person0.getOrigin());
  }
