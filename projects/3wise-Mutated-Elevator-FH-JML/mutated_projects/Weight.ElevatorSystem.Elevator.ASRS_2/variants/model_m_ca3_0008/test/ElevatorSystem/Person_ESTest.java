...
public class Person_ESTest extends Person_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Environment environment0 = new Environment(2930);
      Person person0 = new Person("wU&s~6zA'8fG", 16, 16, 16, environment0);
  ...
  public void test06()  throws Throwable  {
      ...
      Person person0 = new Person(" > maximumWeight:", 0, 0, 0, environment0);
      person0.getName();
      assertEquals(0, person0.getWeight());
