...
public class Graph_ESTest extends Graph_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Graph graph0 = new Graph();
      Vertex vertex0 = new Vertex();
      vertex0.name = "$i4xVL)yr:";
      EdgeIfc edgeIfc0 = graph0.addEdge(vertex0, vertex0);
      LinkedList<String> linkedList0 = new LinkedList<String>();
      linkedList0.add("LlJI4^* hqn");
  ...
  public void test13()  throws Throwable  {
      ...
      vertex1.representative = vertex0;
      graph0.addVertex(vertex1);
      graph0.addEdge(vertex1, vertex1.representative);
  ...
  public void test25()  throws Throwable  {
      ...
      vertex1.name = "\"vh.vv_!OQ5eA_hxG9M";
      EdgeIfc edgeIfc0 = graph0.addEdge(vertex0, vertex1);
      vertex0.name = "\"vh.vv_!OQ5eA_hxG9M";
      vertex0.name = "\"v?.vv_!OQseA_hxG9M";
      EdgeIfc edgeIfc1 = graph0.addEdge(vertex1, ((Edge) edgeIfc0).start);
      EdgeIfc edgeIfc2 = graph0.findsEdge(((Edge) edgeIfc1).start, ((Neighbor) edgeIfc0).end);
      assertNull(edgeIfc2);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      vertex0.name = "\"vh.vv_!OQ5eA_hxG9M";
      vertex0.name = "\"v?.vv_!OQseA_hxG9M";
      edge0.EdgeConstructor(vertex1.representative, vertex0);
      Edge edge1 = (Edge)graph0.addEdge(vertex1, edge0.start);
      Edge edge2 = (Edge)graph0.findsEdge(vertex1.representative, vertex1);
      assertNotNull(edge2);
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        graph0.findsEdge(vertex1.representative, vertex1);
        fail("Expecting exception: NullPointerException");
