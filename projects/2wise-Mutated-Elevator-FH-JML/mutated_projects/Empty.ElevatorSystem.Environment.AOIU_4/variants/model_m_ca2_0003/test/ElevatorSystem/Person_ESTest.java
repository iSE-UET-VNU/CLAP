...
public class Person_ESTest extends Person_ESTest_scaffolding {
  ...
  public void test12()  throws Throwable  {
      Environment environment0 = new Environment(1454);
      Person person0 = new Person("g", 528, 528, 528, environment0);
      boolean boolean0 = person0.isDestinationReached();
      assertFalse(boolean0);
      assertEquals(528, person0.getDestination());
      assertEquals(528, person0.getOrigin());
      assertEquals(528, person0.getWeight());
  }
