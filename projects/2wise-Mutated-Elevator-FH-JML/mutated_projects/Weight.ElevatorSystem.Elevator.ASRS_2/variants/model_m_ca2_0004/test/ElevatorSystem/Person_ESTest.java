...
public class Person_ESTest extends Person_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Environment environment0 = new Environment(2934);
      Person person0 = new Person("%nx-N", 0, 0, 0, environment0);
      Elevator elevator0 = new Elevator(environment0, true, 2934, true);
  ...
  public void test17()  throws Throwable  {
      ...
      floorArray0[0] = floor0;
      environment0.floors = floorArray0;
      Person person0 = new Person("8x/mdXyZZxiraoij", 0, 0, 0, environment0);
      person0.getName();
      assertEquals(0, person0.getWeight());
      assertEquals(0, person0.getDestination());
      assertFalse(person0.isDestinationReached());
