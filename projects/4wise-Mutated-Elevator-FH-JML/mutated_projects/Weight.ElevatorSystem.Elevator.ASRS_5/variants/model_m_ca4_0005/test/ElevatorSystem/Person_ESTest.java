...
public class Person_ESTest extends Person_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Person person0 = new Person("", 0, 35, 0, environment0);
  ...
  public void test05()  throws Throwable  {
      ...
      Person person0 = new Person("ElevatorSystem.Elevator", 0, 0, 0, environment0);
      person0.getName();
      assertEquals(0, person0.getDestination());
      assertFalse(person0.isDestinationReached());
      assertEquals(0, person0.getWeight());
  ...
  public void test12()  throws Throwable  {
      ...
      Person person0 = new Person("", 0, 35, 0, environment0);
      int int0 = person0.getWeight();
      assertEquals(35, person0.getOrigin());
      assertEquals(0, person0.getDestination());
      assertFalse(person0.isDestinationReached());
      assertEquals(0, int0);
  }
  ...
  public void test16()  throws Throwable  {
      Environment environment0 = new Environment(1350);
      Person person0 = new Person("'|nlf_e17E|9Q", 10, 10, 10, environment0);
      boolean boolean0 = person0.isDestinationReached();
