...
public class Person_ESTest extends Person_ESTest_scaffolding {
  ...
  public void test12()  throws Throwable  {
      Environment environment0 = new Environment(1410);
      Person person0 = new Person("|B~~)(P:Z%MQPp", 1410, 77, 77, environment0);
      boolean boolean0 = person0.isDestinationReached();
      assertFalse(boolean0);
      assertEquals(77, person0.getOrigin());
      assertEquals(1410, person0.getWeight());
      assertEquals(77, person0.getDestination());
  }
