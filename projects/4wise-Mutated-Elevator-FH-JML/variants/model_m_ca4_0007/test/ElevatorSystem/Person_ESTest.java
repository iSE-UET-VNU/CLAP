...
public class Person_ESTest extends Person_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Environment environment0 = new Environment(3005);
      Person person0 = new Person("ElevatorSystem.Person", 23, 23, 23, environment0);
      Elevator elevator0 = new Elevator(environment0, false, 3005, false);
      person0.enterElevator(elevator0);
      assertEquals(23, person0.getOrigin());
      assertEquals(23, person0.getWeight());
      assertFalse(person0.isDestinationReached());
      assertEquals(23, person0.getDestination());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      Person person0 = new Person("", 1, 1, 1, environment0);
  ...
  public void test12()  throws Throwable  {
      ...
      environment0.floors = floorArray0;
      floorArray0[0] = floor0;
      Person person0 = new Person("$VALUES", 0, 0, 0, environment0);
      boolean boolean0 = person0.isDestinationReached();
      assertEquals(0, person0.getWeight());
