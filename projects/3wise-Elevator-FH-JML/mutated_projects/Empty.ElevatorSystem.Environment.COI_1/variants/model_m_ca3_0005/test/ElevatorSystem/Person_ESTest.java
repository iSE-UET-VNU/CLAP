...
public class Person_ESTest extends Person_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      Environment environment0 = new Environment(1578);
      Person person0 = new Person("|oX%kpvz-;WFaWeN", 1342, 1342, 1342, environment0);
      int int0 = person0.getDestination();
      assertFalse(person0.isDestinationReached());
      assertEquals(1342, person0.getOrigin());
      assertEquals(1342, person0.getWeight());
