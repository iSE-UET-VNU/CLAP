...
public class Person_ESTest extends Person_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Environment environment0 = new Environment(2507);
      Person person0 = new Person("cFose", 95, 95, 95, environment0);
      int int0 = person0.getWeight();
      assertFalse(person0.isDestinationReached());
      assertEquals(95, person0.getDestination());
      assertEquals(95, person0.getOrigin());
  ...
  public void test15()  throws Throwable  {
      Environment environment0 = new Environment(2695);
      Person person0 = new Person("B8", 0, 0, 0, environment0);
      boolean boolean0 = person0.isDestinationReached();
