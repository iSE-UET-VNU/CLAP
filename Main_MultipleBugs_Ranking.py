...
if __name__ == "__main__":
    base_folder = "temp"
    base_dir = "/Users/thu-trangnguyen/Downloads/VarCop/Debug/"
    system_names = ["Email"]
    bug_folders = ["1Bug"]
    alpha = [0.5]
    kwise_list = ["4wise"]
            ...
            for bug_folder in bug_folders:
                ...
                for kwise in kwise_list:
                    for coverage in coverage_versions:
                        print(coverage)
                        multiple_bugs_ranking(result_folder, system_name, bug_folder,  bug_folder_dir, kwise, [FLEISS], 0.0, coverage, k)
