...
from ExperimentResultManager import SPC_FAILING_ONLY_HEADER, SPC_BOTH_HEADER, SPC_LAYER_HEADER, SPC_SPACE_HEADER, \
...
SPC_BOTH_EXAM_HEADER = "SPC_BOTH_EXAM"
...
SPC_BOTH_EXAM_COL = 8
SPC_LAYER_COL = 9
SPC_LAYER_EXAM_COL = 10
SPC_SPACE_COL = 11
SPECTRUM_COL = 12
SPECTRUM_EXAM_COL = 13
SPECTRUM_SPACE_COL = 14
FEATURE_COL = 15
FEATURE_STM_COL = 16
FEATURE_STM_EXAM_COL = 17
FEATURE_SPACE_COL = 18
...
def write_header_in_sumary_file(row, sheet):
    ...
    sheet.write(row, SPC_BOTH_EXAM_COL, SPC_BOTH_EXAM_HEADER)
...
def calculate_average_in_a_file(experimental_file_dir, num_of_program_stms, row, sheet):
    ...
    for spectrum_expression_type in [TARANTULA, OCHIAI, OP2, BARINEL, DSTAR, RUSSELL_RAO, SIMPLE_MATCHING, ROGERS_TANIMOTO, AMPLE, JACCARD, COHEN, SCOTT, ROGOT1, GEOMETRIC_MEAN, M2, WONG1, SOKAL]:
        ...
        spc_failing_average = calculate_average_value_of_a_list(excel_data_df[spectrum_expression_type][SPC_FAILING_ONLY_HEADER], excel_data_df[spectrum_expression_type][SPC_FAILING_ONLY_HEADER])
        ...
        sheet.write(row, SPC_BOTH_COL, spc_both_average)

        spc_both_exam = (spc_both_average / num_of_program_stms) * 100
        sheet.write(row, SPC_BOTH_EXAM_COL, spc_both_exam)
...
def summary_for_same_bugs(files_list, num_of_program_stms):
    ...
    for file in overall_info.keys():
        ...
        for spectrum_expression_type in [TARANTULA, OCHIAI, OP2, BARINEL, DSTAR, RUSSELL_RAO, SIMPLE_MATCHING, ROGERS_TANIMOTO, AMPLE, JACCARD, COHEN, SCOTT, ROGOT1, GEOMETRIC_MEAN, M2]:
            ...
            spc_failing_average = calculate_average_value_of_a_list(list(data[spectrum_expression_type][SPC_FAILING_ONLY_HEADER]), list(data[spectrum_expression_type][SPC_FAILING_ONLY_HEADER]))
            sheet.write(row, SPC_FAILING_ONLY_COL, spc_failing_average)
            ...
            spc_both_average = calculate_average_value_of_a_list(
                list(data[spectrum_expression_type][SPC_BOTH_HEADER]),
            ...
            spc_layer_average = calculate_average_value_of_a_list(
                list(data[spectrum_expression_type][SPC_LAYER_HEADER]),
                list(data[spectrum_expression_type][SPC_FAILING_ONLY_HEADER]))
            sheet.write(row, SPC_LAYER_COL, spc_layer_average)
            ...
            spc_space = calculate_average_value_of_a_list(
                list(data[spectrum_expression_type][SPC_SPACE_HEADER]),
                list(data[spectrum_expression_type][SPC_FAILING_ONLY_HEADER]))
            sheet.write(row, SPC_SPACE_COL, spc_space)
